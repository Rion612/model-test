import { modelTestConstants } from '../Actions/constants'
...
export default (state = initialState, action) => {
    switch (action.type) {
        case modelTestConstants.GET_MODELTEST_REQUEST:
            state = {
                ...initialState,
                loading: true
            }
            break;
        case modelTestConstants.GET_MODELTEST_SUCCESS:
            state = {
                ...state,
                modeltests: action.payload.modeltests,
                loading: false
            }
            break;
        case modelTestConstants.GET_MODELTEST_FAILURE:
            state = {
                ...state,
                loading: false,
