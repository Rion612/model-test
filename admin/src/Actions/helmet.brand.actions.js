...
import { helemtbrandConstants } from "./constants";

export const getHelmetBrand = () => {
    return async dispatch => {
        dispatch({ type: helemtbrandConstants.GET_HELMET_BRAND_REQUEST });


        await axios.get('/get/helmet/brands')
            .then((res) => {
                if (res.status === 200) {

                    dispatch({
                        type: helemtbrandConstants.GET_HELMET_BRAND_SUCCESS,
                        payload: {
                    ...
                    dispatch({
                        type: helemtbrandConstants.GET_HELMET_BRAND_FAILURE,
                        payload: {
